...
import test.util.CollectionUtil;
import test.util.PropsUtil;
...
public final class DatabaseHelper {
     ...
     * 删除实体
     */
    public static <T> boolean deleteEntity(Class<T> entityClass, Object key, Object value) {
        String sql = "DELETE FROM " + getTableName(entityClass) + " WHERE " + key + " = ?";
        return executeUpdate(sql, value) == 1;
    }
